...
import { Image as ImageIcon, ArrowLeft, Save, BookOpen, Calendar, Layout } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ padding: SPACING.LG }}>
        <ConfigItem title="Banner de Eventos" sub="Tela principal de eventos" icon={Layout} dbKey="events_hero_image" />
