/**
 * Página de um ministério específico: tarefas e responsabilidades, agenda mensal e membros.
 */
...
export default function MinistryDetailScreen() {
  ...
  const handleRemoveMember = (id: string, name: string) => {
    Alert.alert('Remover membro', `Remover ${name} deste ministério?`, [
      { text: 'Cancelar', style: 'cancel' },
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('MinistryAgenda', { ministryKey })}
          activeOpacity={0.7}
        >
